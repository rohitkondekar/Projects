...
<div id="stylized" class="myform">
            ...
            <form id="test_descfrm" name="test_descfrm" method="post" action="regform_testdesc.jsp" onsubmit="return validateTestdescForm();">
    ...
    <ul><strong><u>Javascript is not enabled on your browser. For better functionality, please enable it before you fill the information.</u></strong></ul>
           ...
           <label><span>Topic Name :<strong>*</strong></span>
              ...
              <select id="topname" name="topname" onfocus="showRequiredInfo('topnameInfo');" onblur="hideRequiredInfo()"/>
                ...
                <div id="topnameInfo" class="required">Enter topic Name. Alpha-numeric characters are allowed.Length should be between 3-25 characters.</div>
                <h5  id="topnameError">Invalid name.</h5>
                ...
                <div id="marksInfo" class="required">
                               Enter marks obtained by student (only numbers).
       
                </div>
                <h5  id="marksError">Invalid format of marks.</h5>
             
                
                <label><span>Duration :<strong>*</strong></span>
                    <input id="dur" type="text" name="dur" value="" onfocus="showRequiredInfo('durInfo');" onblur="hideRequiredInfo();"/>
                </label>
                <div id="durInfo" class="required">Enter the duration of test (in minutes).Length of input should be between 1-10 characters(number only).</div>
                <h5 id="durError">Please enter valid duration</h5>
              

                

                <label><span>Display name :<strong>*</strong></span>
                <input id="dname" type="text" name="dname" value=""  onfocus="showRequiredInfo('dnameInfo');" onblur="hideRequiredInfo()"/>
                </label>
                <div id="dnameInfo" class="required">Gives the name assigned to test. No. of characters should be in range 3-20 without space.</div>
                <h5 id="dnameError">Please enter correct name.</h5>
                
                
                  <label><span>Test Description :<strong>*</strong></span>
                    <textarea name="tdesc" cols="26" rows="6" onfocus="showRequiredInfo('tdescInfo');" onblur="hideRequiredInfo()"></textarea>
                </label>
                <div id="tdescInfo" class="required">
                              Please provide description of test. Use upto 100 characters.
       
                </div>
                <h5 id="tdescError">Improper Description</h5>
                
                <div class="spacer"></div>

                <div class="controls">
                    <button type="submit">Done</button>
                    <button type="reset" onclick="resetTestDescForm();">Reset</button>
                </div>
                <br />
